...
import (
	...
	"github.com/uvite/gvmbot/pkg/exchange"
	"github.com/uvite/gvmbot/pkg/fixedpoint"
	"github.com/uvite/gvmbot/pkg/interact"
	"github.com/uvite/gvmbot/pkg/notifier/slacknotifier"
	"github.com/uvite/gvmbot/pkg/notifier/telegramnotifier"
	"github.com/uvite/gvmbot/pkg/service"
	"github.com/uvite/gvmbot/pkg/slack/slacklog"
...
func (session *ExchangeSession) getSessionSymbols(defaultSymbols ...string) ([]string, error) {
	...
	if session.Futures {
		...
		for s := range session.initializedSymbols {
